# -*- coding: utf-8 -*-
"""
Created on Thu May  2 14:43:36 2019
...
def read_article(article_ID, root_dir = "E:/bio_TM/clinical_trials_data/"):
...
def extract_matches(article_ID, root_dir = "E:/bio_TM/clinical_trials_data/"):
    schema = json.load(open("E:/bio_TM/compounded.json", "r"))
...
article_IDs = open("E:/bio_TM/article_IDs.txt", "r").readlines()
...
json.dump(processed, open("E:/bio_TM/processed_articles.json", "w"))

compounded = build_compounded(processed)

json.dump(compounded, open("E:/bio_TM/compounded.json", "w"))